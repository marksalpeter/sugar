...
Sugar is a simple wrapper around the `testing.T` library that clarifies and colorizes test output and and better organize test funcs. For full documentation see the godoc. If you've got any questions, check the gitter or tweet @marksalpeter. 
